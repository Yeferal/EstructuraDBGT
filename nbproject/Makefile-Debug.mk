...
${OBJECTDIR}/LIstaColumnas.o: LIstaColumnas.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LIstaColumnas.o LIstaColumnas.cpp

${OBJECTDIR}/ListaTabla.o: ListaTabla.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListaTabla.o ListaTabla.cpp

${OBJECTDIR}/ListaTupla.o: ListaTupla.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListaTupla.o ListaTupla.cpp
...
${OBJECTDIR}/Pintar.o: Pintar.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Pintar.o Pintar.cpp
